...
use super::super::super::common_rpc_types::NodeName;
use super::super::AgentExtra;

pub fn get(conn: &postgres::Connection, node_name: &NodeName) -> postgres::Result<Option<AgentExtra>> {
...
pub fn upsert(conn: &postgres::Connection, node_name: &NodeName, agent_extra: &AgentExtra) -> postgres::Result<()> {
